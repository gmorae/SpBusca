                  ...
                  <div class="card-body">
                        ...
                        <h2 class="h1-responsive font-weight text-center mb-5"> Cadastro de empresa / lojas</h2>
                              ...
                              <div class="md-form">
                                    ...
                                    <label for="nome" class="font-weight-light">Empresa / loja</label>
                              </div>
                              <div class="md-form">
                              ...
                              <div class="md-form">
                                    <i class="fa fa-user prefix grey-text"></i>
                                    <input type="text" id="email" name="email" value="<?= set_value('email'); ?>" class="form-control" required>
                                    <label for="email" class="font-weight-light">Login</label>
                              </div>

                              <div class="md-form">
                                    <i class="fa fa-lock prefix grey-text"></i>
                                    <input type="password" id="senha" name="password" value="<?= set_value(''); ?>" class="form-control" required>
                                    <label for="senha" class="font-weight-light">Senha (A senha deve ter no minímo 6 caracteres)</label>
                              ...
                              <div class="md-form">
                                    ...
                                    <input type="text" id="cnpj" value="<?= set_value('cnpj'); ?>" name="cnpj" class="form-control">
                                    <label for="cnpj" class="font-weight-light">CNPJ</label>
                              </div>
                              <div class="md-form">
                                    <i class="far fa-envelope prefix grey-text"></i>
